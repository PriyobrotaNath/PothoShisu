...
<div class="container">
  <h1>Donation Category</h1>
    ...
    <center>
    <li><a href="index.php" class="btn btn-primary btn-lg btn-block" title="Welcome" >User Info</a></li>
    <li><a href="category.php" class="btn btn-primary btn-lg btn-block " title="Welcome" >posts</a></li>
    </ul>
