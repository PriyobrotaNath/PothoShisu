  ...
  while ($row = $user_list->fetch_assoc()) {
     ?>
             <tr>
                ...
                <td class="text-right">
                    <a  href="<?php echo 'post_delete.php?id=' . $row["id"] ?>" class="btn btn-success">Delete</a>  
                    <a  href="<?php echo 'post_update.php?id=' . $row["id"] ?>" class="btn btn-primary">Update</a>  
                    <a href="<?php echo 'post_view.php?id=' . $row["id"] ?>" class="btn btn-info">View</a>
                </td>
