...
<div class="container">
  <h1>Donation Category</h1>
    ...
    <center>
    <li><a href="food_donation.php" class="btn btn-primary btn-lg btn-block" title="Welcome" >Food</a></li>
    <li><a href="manpower.php" class="btn btn-primary btn-lg btn-block " title="Welcome" >Manpower (Want To Teach / Volunteer)</a></li>
    </ul>
